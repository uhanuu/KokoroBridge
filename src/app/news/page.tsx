...
const newsData = [
  {
    ...
    icon: NewReleases,
    color: "#22c55e",
    image: "/news/hiragana-katakana-release.png",
    features: [
      "46개 히라가나 문자 완벽 학습",
      "46개 가타카나 문자 마스터",
      "실시간 필기 인식 기능",
  ...
  },
  {
    ...
    icon: Schedule,
    color: "#f59e0b",
    image: "/news/kanji-coming-soon.png",
    features: [
      "기초 한자 100개 학습",
      "음독, 훈독 발음 학습",
      "한자 구성 요소 분석",
  ...
  },
  {
    ...
    icon: Announcement,
    color: "#8b5cf6",
    image: "/news/ai-conversation-beta.png",
    features: [
      "실시간 AI 대화 연습",
      "상황별 대화 시나리오",
      "발음 평가 및 피드백",
  ...
  },
  {
    ...
    icon: Update,
    color: "#3b82f6",
    image: "/news/progress-tracking-update.png",
    features: [
      "상세 학습 통계 제공",
      "진도 달성률 시각화",
      "학습 패턴 분석",
  ...
  },
  {
    ...
    icon: Event,
    color: "#ef4444",
    image: "/news/7day-challenge-event.png",
    features: [
      "7일 연속 학습 챌린지",
      "특별 배지 획득",
      "프리미엄 기능 1주일 무료",
...
export default function NewsPage() {
  ...
  const handleMarkAllAsRead = () => {
    setNews(prevNews =>
      prevNews.map(item => ({ ...item, isRead: true }))
    );
  };
